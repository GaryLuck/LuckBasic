...
sub do_command(cmd as string)
    ...
    elseif left$(cmd, 4) = "LOAD" then
        ...
        call do_load(trim$(mid$(cmd, 5)))
        
    elseif left$(cmd, 4) = "SAVE" then
  
        call do_save(trim$(mid$(cmd, 5)))
